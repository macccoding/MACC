            ...
            <GlowBorder glowColor={`${venture.color}66`} hoverOnly borderRadius={12}>
              <HeroCursorTilt>
                <motion.div
                  ...
                  className="aspect-[4/3] relative w-full overflow-hidden rounded-lg bg-bg-primary backdrop-blur-sm border border-white/[0.06]"
                >
                  {venture.coverImage ? (
                    <Image
...
export default function HomeClient({ ventures }: { ventures: VenturePreview[] }) {
